...
Players have made their characters. Now they introduce them to each other, in character, briefly.

**GM move:** prompt each player in turn.

> **GM script:** *"Tell us your name, what you look like in one sentence, what you do in the bookshop on a normal day, and one thing your character carries that they wouldn't loan to anyone here."*
...
The crew is its own protagonist with its own sheet. Walk the table through this together — collaborative, not GM-fiat.

### Crew type and name

- **Crew type:** Hunters *(per the bible)*. Confirm at the table — it's a one-line decision.
- **Crew name:** **Curios & Chronicles** *(canonical — this is the front)*.

### The lair

> **READ ALOUD — the lair, the public face:**
>
...
Then read the Containment Suite tour:

> **READ ALOUD — the Containment Suite:**
>
...
Each player has their Close Friend, Rival, and Cursed Heirloom on their sheet. Walk around the table:
...
End with a quiet, atmospheric beat that establishes the *feeling* of the campaign without starting the work.
