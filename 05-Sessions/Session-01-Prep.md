...
status: Prep
goal: "Teach the Blades loop — Engagement → Action → Consequence → Resistance → Downtime."
mechanical_focus: "Tutorial: Position/Effect, Devil's Bargains, and Stress/Resistance."
---
...
* **Position & Effect:** Explicitly state these for every roll. Say them out loud for the players.
* **Flashbacks:** Invite flashbacks twice in the first hour to teach the mechanic.
* **Mechanical Tracking:** The **[Clock: Detection]** (4-seg) is the only active clock. Tick it visibly on the Dashboard.
* **The Three-Layer Rule:** Applies to **[NPC: Merton]**. Keep Merton's tragedy available if players investigate, but do not surface it unprompted.
...
>
> The bell above the door chimes. A courier in a grey **[Faction: The Ministry]** uniform drops a damp manila envelope on the counter without a word and walks back out into the rain.
>
...
2. **Actually is:** A Barghest. **Anchor Item:** **[Item: Leather Dog Collar]** (1823).
3. **Became this because:** Summoned without consent in 1823. Has been fighting what he is every night since.

**Mechanical Weakness:** A Critical Success on *Study* or *Gather Info* reveals that severing the **[Item: Leather Dog Collar]** removes his armor and reduces his Threat Level.
...
* **Devil's Bargain Menu:** Offer +1d for: Ticking **[Clock: Detection]** OR damaging gear.
...
* **Scribe Protocol:** Record the players' choices regarding the Gland and the Collar to update the **[Ledger: Anchor Ledger]** and **[Tracker: Crew Inventory]**.
